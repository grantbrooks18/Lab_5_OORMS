...
class OORMSTestCase(unittest.TestCase):
    ...
    def test_order_controller_update_several_then_cancel(self):
         ...
         def check_first_three_items(menu_items, items):
             ...
             self.assertEqual(menu_items[5], items[1].details)
    ...
    def test_receipt(self):
        seats = [0, 4]
        billing = [0, 0]
        self.view.controller.table.receipt.update_receipt(seats,billing)
        self.assertEqual(0, self.view.controller.table.receipt.seats[0])
        self.assertEqual(4, self.view.controller.table.receipt.seats[1])

        self.assertEqual(0, self.view.controller.table.receipt.seats[0])
        self.assertEqual(0, self.view.controller.table.receipt.seats[1])
